...
# This program reads audio.wav file in this folder and generates a new file called "AudioVector.mat" with the vector X and the sample frequency Fs inside it.
...
[X,Fs] = audioread(file_in_loadpath("../Corpus.wav"));
