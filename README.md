...
#### Preparing the data to Test the SVM algorithm
...
6. Finally, run the following script from Matlab `>> processes_data_for_test_supervision_M(1,start_marks,end_marks)`. Such script will prepare the MRSTSA outputs and the EL outputs to test the SVM already trained models.
