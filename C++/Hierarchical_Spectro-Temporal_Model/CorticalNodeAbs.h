...
// File Name:		CorticalNodeAbs.h
// File Description:	CorticalNodeAbs class definition. This file presents CorticalNodeAbs' public
//			interface without revealing the implementations of CorticalNodeAbs' member functions,
//			which are defined in CorticalNodeAbs.cpp.
...
#ifndef CORTICALNODEABS_H
#define CORTICALNODEABS_H

#include <thread>
#include "CorticalLayer4.h"					// includes the definition of class CorticalLayer4
#include "CorticalLayer5.h"					// includes the definition of class CorticalLayer5
#include "CorticalLayer6.h"					// includes the definition of class CorticalLayer6
#include "CorticalLayer23.h"					// includes the definition of class CorticalLayer23

class CorticalNodeAbs
{
public:
		CorticalNodeAbs( int, int, int, int, int, CorticalLayer4 &, CorticalLayer5 &, CorticalLayer6 &, CorticalLayer23 & );	// constructor that initializes CorticalNodeAbs
...
private:
	...
	CorticalLayer4		layer4;					// this is the layer 4 in the cortical node
	CorticalLayer5		layer5;					// this is the layer 5 in the cortical node
	CorticalLayer6		layer6;					// this is the layer 6 in the cortical node 
	CorticalLayer23		layer23;				// this is the layer 23 in the cortical node
}; // end class CorticalNodeAbs
