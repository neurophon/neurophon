...
// File Name:		CorticalLayer4.cpp
// File Description:	CorticalLayer4 member-function definitions. This file contains implementations of the
//			member functions prototyped in CorticalLayer4.h.

#include <iostream>
#include <stdlib.h>							// calloc, exit, free
#include <float.h>
#include "CorticalLayer4.h"						// include definition of class CorticalLayer4

using namespace std;

// constructor initializes the dimensionality of the input and output vectors, this function validates the object too 
CorticalLayer4::CorticalLayer4( int inputDim, int outputDim, KohonenFeatureMapPred &clusterOfNeurons )
...
} // end CorticalLayer4 constructor


// function to validate the object created of this class
void	CorticalLayer4::validateObject()
{
	...
	{
		cout << "CorticalLayer4 object inconsistence: inputDimensionality = " << inputDim << " and inputClusterDim = " << inputClusterDim << "\n" << endl;
		cout << "CorticalLayer4 object inconsistence: outputDimensionality = " << outputDim << " and outputClusterDim = " << outputClusterDim << "\n" << endl;
		exit( EXIT_FAILURE );
	}
...
void	CorticalLayer4::propagateSignals( neurotransmitters parameter )
{
	levelOfExcitation level;

	level = CorticalLayer4::excitationLevel();				// obtains the level of excitation to the cortical layer
	if ( level.active )							// if this input is active
	{
		CorticalLayer4::putOnInput();
...
levelOfExcitation	CorticalLayer4::excitationLevel()
{
...
void	CorticalLayer4::putOnInput()
{
	double	*inputVectorPointer;
...
void	CorticalLayer4::putOnOutput()
{
